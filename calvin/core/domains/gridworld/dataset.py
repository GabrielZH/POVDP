...
from core.dataset import add_demo_gen_args, generate_grid_expert_demos
from core.domains.gridworld.map.parse_gridmap import get_map, add_map_args


def get_save_path(data=None, n_envs=None, n_episodes_per_env=None, 
                  map=None, view_range=None, min_traj_len=None,
...
def main():
    ...
    gen_grid_expert_demos(vars(config))
