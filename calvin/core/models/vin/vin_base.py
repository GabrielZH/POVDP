...
class VINBase(Model):
    def __init__(
        ...
        self.sparse = sparse
        self.dense = dense
        self.soft_indexing = soft_indexing
        self.belief_labeling = belief_labeling
...
def add_vin_args(parser):
    ...
    parser.add_argument('--l_hs', type=tuple, default=(128, 256), help='Numbers of channels in hidden layers')
    ...
    parser.add_argument('--soft_indexing', action='store_true', default=False, help='Use soft indexing to extract state value')
    parser.add_argument('--belief_labeling', default='probabilities', help='The form of labeling a belief state')
