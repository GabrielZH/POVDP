...
from core.models.calvin.calvin_conv2d import CALVINConv2d, CALVINPosNav, POCALVINConv2d
...
def get_model_class_from_name(name):
    available = [CALVINConv2d, CALVINConv3d, CALVINPosNav, CALVINPoseNav, POCALVINConv2d,
